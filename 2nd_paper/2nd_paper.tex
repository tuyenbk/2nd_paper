...
%---noun6: staff, personnel, industry expert, practitioner, academic community, reseachers, professionals, 
%---noun7: stage, phase, 
...
%---verb2: affect, impact, influence, trigger, create, transform (transformative), enable (enabler, enabling), allow, support (supporting), ensure, generate (generation), result in, improve, facilitate, underpin (underpinning), adjust, tailor, accomodate, modify, change, redefine
...
%---linking3: as reported by the FAA, 
